...
var japanPrefectures = ["Kyoto", "Nara", "Saga", "Tochigi", "Osaka"];
...
var planets = ["Mercury", "Venus", "Earth", "Mars", "Jupiter", "Saturn", "Uranus", "Nepture", "Pluto"];
console.log(planets);
...
Bteam:  []
  ...
  if(i % 2 === 0){
    newTeams.Ateam.push(roster[i]);
  } else {
    newTeams.Bteam.push(roster[i]);
  }
  }
...
console.log("The value at " + i + " is: " + japanPrefectures[i]);
}
